...
> **Goal:** Real‑time recognition of exercise type from webcam/video using MediaPipe Pose + pose‑feature engineering + a 2‑layer Bi‑LSTM. Includes a **squat‑only rep counter** based on knee‑angle hysteresis.
